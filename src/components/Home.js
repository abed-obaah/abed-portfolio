      ...
      <div className="section-content">
        <div className="home-content">
          ...
          <ul className="social-connect">
            ...
            <li>
              <a href="https://www.linkedin.com/in/johnadibe/" target="_blank" rel="noopener noreferrer">
                <FontAwesomeIcon icon={faLinkedin} />
              </a>
            </li>
            <li>
              <a href="https://twitter.com/johnphealipto" target="_blank" rel="noopener noreferrer">
