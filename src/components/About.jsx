    ...
    <section id="about">
      <div className="section-content">
        ...
        <div className="about-details">
          ...
          <p>Today, I am currently working as a Software Developer at <a href="https://www.outcess.com/" className="a_link" target="_blank">Outcess</a> where I build enhanced solution provided applications.</p>
